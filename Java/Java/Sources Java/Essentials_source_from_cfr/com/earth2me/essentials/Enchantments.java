...
public class Enchantments {
    ...
    public static Enchantment getByName(String name) {
        Enchantment enchantment = NumberUtil.isInt(name) ? Enchantment.getById((int)Integer.parseInt(name)) : Enchantment.getByName((String)name.toUpperCase(Locale.ENGLISH));
        if (enchantment == null) {
