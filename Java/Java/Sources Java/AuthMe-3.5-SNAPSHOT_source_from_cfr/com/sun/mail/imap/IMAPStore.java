...
ResponseHandler {
    ...
    private void emptyConnectionPool(boolean force) {
        ConnectionPool connectionPool = this.pool;
        synchronized (connectionPool) {
            for (int index = ConnectionPool.access$000((ConnectionPool)this.pool).size() - 1; index >= 0; --index) {
                try {
    ...
    public synchronized void close() throws MessagingException {
        ...
        try {
            try {
                ...
                boolean isEmpty = this.pool.authenticatedConnections.isEmpty();
        ...
        try {
            block29 : {
                ...
                try {
                    block28 : {
                        ...
                        synchronized (connectionPool2) {
                            ...
                            if (this.pool.idleState != 0) {
                                ...
                                Object var8_12 = null;
                                if (needNotification) {
                                    ConnectionPool connectionPool3 = this.pool;
                        ...
                        do {
                            ...
                            synchronized (ex) {
                                if (r == null || !p.processIdleResponse(r)) {
                                    ...
                                    // MONITOREXIT [1, 2, 21, 26, 13] lbl46 : MonitorExitStatement: MONITOREXIT : ex
                    ...
                    Object var8_13 = null;
                    if (!needNotification) break block29;
                    connectionPool = this.pool;
                }
                catch (BadCommandException bex) {
