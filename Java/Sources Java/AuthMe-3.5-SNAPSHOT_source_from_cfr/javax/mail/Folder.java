...
public abstract class Folder {
    ...
    public Message[] search(SearchTerm term, Message[] msgs) throws MessagingException {
        ...
        Object[] m = new Message[matchedMsgs.size()];
    ...
    public synchronized void addConnectionListener(ConnectionListener l) {
        if (this.connectionListeners == null) {
            this.connectionListeners = new Vector<E>();
        }
    ...
    public synchronized void addFolderListener(FolderListener l) {
        if (this.folderListeners == null) {
            this.folderListeners = new Vector<E>();
        }
    ...
    public synchronized void addMessageCountListener(MessageCountListener l) {
        if (this.messageCountListeners == null) {
            this.messageCountListeners = new Vector<E>();
        }
    ...
    public synchronized void addMessageChangedListener(MessageChangedListener l) {
        if (this.messageChangedListeners == null) {
            this.messageChangedListeners = new Vector<E>();
        }
    ...
    private void terminateQueue() {
        ...
        synchronized (object) {
            if (this.q != null) {
                Vector<E> dummyListeners = new Vector<E>();
