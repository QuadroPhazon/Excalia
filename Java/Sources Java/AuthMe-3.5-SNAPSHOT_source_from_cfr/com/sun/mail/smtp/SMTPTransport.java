...
extends Transport {
    ...
    protected SMTPTransport(Session session, URLName urlname, String name, boolean isSSL) {
        ...
        boolean bl = this.noauthdebug = !PropUtil.getBooleanSessionProperty(session, "mail.debug.auth", false);
        if (urlname != null) {
            ...
            block23 : {
                ...
                block24 : {
                    ...
                    try {
                        ...
                        if (!useAuth && (user == null || passwd == null) || !this.supportsExtension("AUTH") && !this.supportsExtension("AUTH=LOGIN")) break block23;
                        bl2 = connected = this.authenticate(user, passwd);
                        Object var11_11 = null;
                        if (connected) break block24;
                    }
    ...
    private boolean authenticate(String user, String passwd) throws MessagingException {
        ...
        while (st.hasMoreTokens()) {
            ...
            if (!this.supportsAuthentication(m = m.toUpperCase(Locale.ENGLISH))) {
    ...
    public boolean sasllogin(String[] allowed, String realm, String authzid, String u, String p) throws MessagingException {
        ...
        try {
            ...
            boolean st = this.saslAuthenticator.authenticate(mechs, realm, authzid, u, p);
    ...
    private void closeConnection() throws MessagingException {
        try {
            ...
            this.serverInput = null;
            this.lineInputStream = null;
            if (!super.isConnected()) throw var2_4;
            super.close();
            throw var2_4;
        }
    }
    ...
    private boolean convertTo8Bit(MimePart part) {
        ...
        try {
            if (part.isMimeType("text/*")) {
                ...
                if (enc == null || !enc.equalsIgnoreCase("quoted-printable") && !enc.equalsIgnoreCase("base64")) return changed;
                InputStream is = null;
                try {
                    ...
                    Object var6_9 = null;
                    if (is == null) return changed;
                }
                catch (Throwable var5_13) {
                    Object var6_10 = null;
                    if (is == null) throw var5_13;
                    try {
                        is.close();
                        throw var5_13;
                    }
            ...
            if (!part.isMimeType("multipart/*")) return changed;
            MimeMultipart mp = (MimeMultipart)part.getContent();
            int count = mp.getCount();
            int i = 0;
            while (i < count) {
                if (this.convertTo8Bit((MimePart)((Object)mp.getBodyPart(i)))) {
                    changed = true;
                }
                ++i;
            }
    ...
    protected void mailFrom() throws MessagingException {
        ...
        block25 : {
            ...
            if (this.supportsExtension("AUTH")) {
                ...
                if (submitter != null) {
                    try {
                        String s = SMTPTransport.xtext(submitter);
                        cmd = cmd + " AUTH=" + s;
                    }
    ...
    protected void rcptTo() throws MessagingException {
        ...
        block11 : for (i = 0; i < this.addresses.length; ++i) {
            sfex = null;
            ...
            switch (retCode) {
                ...
                case 251: {
                    valid.addElement(ia);
                    if (!this.reportSuccess) continue block11;
        ...
        if (sendFailed) {
            ...
            try {
                block48 : {
                    try {
                        if (this.serverSocket == null) break block48;
                        this.issueCommand("RSET", -1);
                    }
            ...
            try {
                block12 : {
                    try {
                        ...
                        if (this.resp != 334) break block12;
                ...
                SMTPTransport.this.resumeTracing();
                if (this.resp == 235) throw var6_10;
                {
                    SMTPTransport.this.closeConnection();
                    throw new AuthenticationFailedException(SMTPTransport.this.getLastServerResponse());
                }
